...
const Testimonials: React.FC = () => {
  ...
  const [feedbackData, setFeedbackData] = useState<Testimonial[]>([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setFeedbackData(response.data.slice(0, 3));
      } catch (error) {
    ...
    >
      ...
      <section className="relative py-14">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(152.92deg, rgba(192, 132, 252, 0) 4.54%, rgba(232, 121, 249, 0) 34.2%, rgba(192, 132, 252, 0) 77.55%)",
          }}
        ></div>
      </section>
    </motion.div>
